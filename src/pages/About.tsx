      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {team.map((t) => (
              <div key={t.initials} className="rounded-xl glass p-6 text-center group hover:bg-card/60 transition-colors">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {offices.map((o) => (
              <div key={o.city} className="rounded-xl glass p-5 text-center">
